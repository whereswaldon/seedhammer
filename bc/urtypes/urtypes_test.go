...
func TestOutputDescriptor(t *testing.T) {
	...
	tests := []struct {
				...
				Keys: []KeyDescriptor{
					{
						...
						Key: *hdkeychain.NewExtendedKey(
							chaincfg.MainNetParams.HDPublicKeyID[:],
							[]byte{0x3, 0xcb, 0xca, 0xa9, 0xc9, 0x8c, 0x87, 0x7a, 0x26, 0x97, 0x7d, 0x0, 0x82, 0x5c, 0x95, 0x6a, 0x23, 0x8e, 0x8d, 0xdd, 0xfb, 0xd3, 0x22, 0xcc, 0xe4, 0xf7, 0x4b, 0xb, 0x5b, 0xd6, 0xac, 0xe4, 0xa7},
							[]byte{0x60, 0x49, 0x9f, 0x80, 0x1b, 0x89, 0x6d, 0x83, 0x17, 0x9a, 0x43, 0x74, 0xae, 0xb7, 0x82, 0x2a, 0xae, 0xac, 0xea, 0xa0, 0xdb, 0x1f, 0x85, 0xee, 0x3e, 0x90, 0x4c, 0x4d, 0xef, 0xbd, 0x96, 0x89},
							[]byte{0x0, 0x0, 0x0, 0x0}, 0, 0x0, false,
						),
					},
					{
						...
						Key: *hdkeychain.NewExtendedKey(
							chaincfg.MainNetParams.HDPublicKeyID[:],
							[]byte{0x2, 0xfc, 0x9e, 0x5a, 0xf0, 0xac, 0x8d, 0x9b, 0x3c, 0xec, 0xfe, 0x2a, 0x88, 0x8e, 0x21, 0x17, 0xba, 0x3d, 0x8, 0x9d, 0x85, 0x85, 0x88, 0x6c, 0x9c, 0x82, 0x6b, 0x6b, 0x22, 0xa9, 0x8d, 0x12, 0xea},
							[]byte{0xf0, 0x90, 0x9a, 0xff, 0xaa, 0x7e, 0xe7, 0xab, 0xe5, 0xdd, 0x4e, 0x10, 0x5, 0x98, 0xd4, 0xdc, 0x53, 0xcd, 0x70, 0x9d, 0x5a, 0x5c, 0x2c, 0xac, 0x40, 0xe7, 0x41, 0x2f, 0x23, 0x2f, 0x7c, 0x9c},
							[]byte{0x0, 0x0, 0x0, 0x0}, 0, 0x0, false,
						),
					},
				},
		...
		{
			twoOfThree,
			"",
		},
		{
			OutputDescriptor{
				Type: P2WPKH, Threshold: 1, Keys: []KeyDescriptor{
					{
						...
						Key: *hdkeychain.NewExtendedKey(
							chaincfg.MainNetParams.HDPublicKeyID[:],
							[]uint8{0x3, 0x3e, 0xd5, 0x1b, 0xcf, 0xf9, 0x30, 0xc6, 0x14, 0xe8, 0x61, 0xbf, 0xed, 0xff, 0x57, 0x69, 0x9b, 0x67, 0x8, 0x5a, 0x9f, 0x19, 0x77, 0x75, 0xbc, 0xc5, 0x41, 0xa9, 0xeb, 0xe8, 0x26, 0x8d, 0xe9},
							[]uint8{0x21, 0x23, 0x99, 0xa8, 0xdb, 0x12, 0x5c, 0x85, 0xf9, 0x41, 0xea, 0x12, 0x23, 0x1d, 0x8b, 0x5c, 0x7a, 0x76, 0xb8, 0x3e, 0x1, 0xd0, 0x3d, 0x16, 0xc5, 0x39, 0x58, 0xc5, 0x18, 0x28, 0x4f, 0x45},
							[]uint8{0xd1, 0xe5, 0xa6, 0x2d}, 3, hdkeychain.HardenedKeyStart, false),
					},
				},
			},
			"d90194d9012fa4035821033ed51bcff930c614e861bfedff57699b67085a9f197775bcc541a9ebe8268de9045820212399a8db125c85f941ea12231d8b5c7a76b83e01d03d16c53958c518284f4506d90130a301861854f500f500f5021a9c43e6c20303081ad1e5a62d",
		},
		{
			OutputDescriptor{
				Type: P2SH_P2WPKH, Threshold: 1, Keys: []KeyDescriptor{
					{
						...
						Key: *hdkeychain.NewExtendedKey(
							chaincfg.MainNetParams.HDPublicKeyID[:],
							[]uint8{0x2, 0xb1, 0x1d, 0x60, 0xe0, 0x23, 0x9, 0xc4, 0x80, 0xbb, 0xa1, 0x37, 0x77, 0x1a, 0xd6, 0x14, 0x62, 0x6b, 0xea, 0xf2, 0xef, 0x74, 0x34, 0x4e, 0xd1, 0xf, 0xd8, 0x3b, 0xb6, 0x3f, 0xeb, 0xcf, 0xa7},
							[]uint8{0x65, 0x8c, 0xa1, 0x47, 0x4, 0xcc, 0x49, 0xcb, 0x6, 0x64, 0x9d, 0x1b, 0xdd, 0x74, 0x6b, 0x11, 0x9f, 0x18, 0x5b, 0xf7, 0x7c, 0x1c, 0x48, 0x30, 0x73, 0xbb, 0x81, 0xe3, 0x35, 0x5a, 0xbc, 0x51},
							[]uint8{0xe9, 0x86, 0x73, 0x4b}, 3, hdkeychain.HardenedKeyStart, false),
					},
				},
			},
			"d90190d90194d9012fa403582102b11d60e02309c480bba137771ad614626beaf2ef74344ed10fd83bb63febcfa7045820658ca14704cc49cb06649d1bdd746b119f185bf77c1c483073bb81e3355abc5106d90130a301861831f500f500f5021a9866232b0303081ae986734b",
		},
		{
			OutputDescriptor{
				Type: P2PKH, Threshold: 1, Keys: []KeyDescriptor{
					{
						...
						Key: *hdkeychain.NewExtendedKey(
							chaincfg.MainNetParams.HDPublicKeyID[:],
							[]uint8{0x2, 0x72, 0x62, 0x46, 0x42, 0x95, 0xd, 0x14, 0x75, 0xf1, 0x6e, 0x46, 0xcc, 0x8d, 0x2b, 0x75, 0xcc, 0x2d, 0xe1, 0x2d, 0xf2, 0x9f, 0x29, 0xcf, 0x36, 0x97, 0x75, 0xb9, 0x5f, 0x66, 0xd2, 0x8e, 0x28},
							[]uint8{0xab, 0x20, 0x95, 0x8c, 0x7e, 0x9e, 0xd9, 0x9c, 0x91, 0x5d, 0x2c, 0x98, 0x7, 0x37, 0xf3, 0x12, 0x38, 0xd3, 0xb5, 0xab, 0x32, 0xb8, 0x8b, 0xda, 0xaa, 0x61, 0x91, 0x5b, 0xb5, 0xb3, 0xb4, 0xa4},
							[]uint8{0xb6, 0x20, 0x41, 0xef}, 3, hdkeychain.HardenedKeyStart, false),
					},
				},
			},
			"d90193d9012fa40358210272624642950d1475f16e46cc8d2b75cc2de12df29f29cf369775b95f66d28e28045820ab20958c7e9ed99c915d2c980737f31238d3b5ab32b88bdaaa61915bb5b3b4a406d90130a30186182cf500f500f5021a9866232b0303081ab62041ef",
		},
		{
			OutputDescriptor{
				Type: P2TR, Threshold: 1, Keys: []KeyDescriptor{
					{
						...
						Key: *hdkeychain.NewExtendedKey(
							chaincfg.MainNetParams.HDPublicKeyID[:],
							[]uint8{0x3, 0xd, 0x9f, 0x35, 0x47, 0x53, 0x4d, 0xd3, 0x32, 0x85, 0x56, 0x11, 0xaf, 0x48, 0xae, 0x34, 0x62, 0x25, 0xb0, 0xd4, 0xe1, 0xe5, 0xf8, 0x10, 0x57, 0xaa, 0x9e, 0x4c, 0x20, 0x58, 0x94, 0x87, 0xc5},
							[]uint8{0xc1, 0xaa, 0x32, 0xa1, 0x3d, 0x12, 0xcf, 0x59, 0x52, 0x8b, 0x58, 0x1e, 0x9b, 0x5d, 0x7, 0x4, 0x68, 0x57, 0x2e, 0x20, 0xf, 0x26, 0x4, 0x76, 0xa2, 0xee, 0xb2, 0x3a, 0xdc, 0x48, 0x4a, 0x43},
							[]uint8{0x7f, 0xef, 0x54, 0x7a}, 3, hdkeychain.HardenedKeyStart, false),
					},
				},
			},
			"d90199d9012fa4035821030d9f3547534dd332855611af48ae346225b0d4e1e5f81057aa9e4c20589487c5045820c1aa32a13d12cf59528b581e9b5d070468572e200f260476a2eeb23adc484a4306d90130a301861856f500f500f5021a9866232b0303081a7fef547a",
		},
	}
	for _, test := range tests {
...
func TestHDKey(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			"a4035821022196adc25fde169fe92e70769059102275d2b40cc98776eaab92b82a86135e92045820438eff7b3b36b6d11a60a22ccb9306eea305b0439f1ea09d5928015de373811606d90130a301881830f500f500f502f5021add4fadee0304081a22969377",
		},
		{
			KeyDescriptor{
				MasterFingerprint: 0xbd16bee5,
