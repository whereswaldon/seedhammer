...
func TestSingle(t *testing.T) {
	...
	if want, got := xpub.String(), k.Key.String(); want != got {
		...
		Keys: []urtypes.KeyDescriptor{
			{
				...
				Key: *hdkeychain.NewExtendedKey(
					...
					[]uint8{0xc7, 0xbc, 0xe7, 0xa8}, 4, 0x80000002, false,
				),
			},
			{
				...
				Key: *hdkeychain.NewExtendedKey(
					...
					[]byte{0x22, 0x96, 0x93, 0x77}, 4, 0x80000002, false,
				),
			},
			{
				...
				Key: *hdkeychain.NewExtendedKey(
					...
					[]byte{0x97, 0xec, 0x38, 0xf9}, 4, 0x80000002, false,
				),
			},
		},
	},
